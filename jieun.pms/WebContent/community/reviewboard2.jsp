				...
				<table class="board_table" border="1">
					<tr>
						<td>
							...
							<button	onclick="popup()">상품 선택</button>
							카테고리 : <input type="text" id="file1" style="width:100px; border:0;" readonly>
								상품이름 : <input type="text" id="file2" style="width:100px; border:0;" readonly>
