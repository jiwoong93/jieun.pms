					...
					<table class="community_table" border="1">
						...
						<c:forEach var="post" items="${posts}">
							<tr>
								...
								<td align="center"><a href="${post.revContents}">${post.revSubject}</a></td>
						...
						<ul class="pagination">
							...
							<c:if test="${pageMaker.prev}">
								<li style="float: left;"><a
									href="review.jsp?currentPage=${pageMaker.startPage-1}">&laquo;</a>&nbsp;&nbsp;</li>
							</c:if>
							...
							<c:forEach begin="${pageMaker.startPage}"
								...
								<li style="float: left;"
									...
									&nbsp;&nbsp;&nbsp;<a href="review.jsp?currentPage=${idx}">${idx}</a>
								</li>
							</c:forEach>
