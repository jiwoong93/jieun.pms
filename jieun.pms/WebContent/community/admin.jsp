...
<body>
<div class="mypage">
	<div class="mypageTitle">관리자<hr></div>
	...
	<div class="mypageContents">
			<table class="community_table" border="1">
				<tr>
					<td width="50" height="40" align="center">선택</td>
				...
				<tr>
					<td align="center"><input type="checkbox" name="checkbox1" value="1"></td>
					<td height="30" align="center">1</td>
					<td align="center">하이하이</td>
