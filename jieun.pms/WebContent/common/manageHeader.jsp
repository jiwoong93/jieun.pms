...
<%
   ...
   if (pageName.equals("main.jsp")) {
      path = "./";
   } else if (pageName.equals("login.jsp") || pageName.equals("findId.jsp") || pageName.equals("findPw.jsp")  || pageName.equals("noticeboard.jsp")
         || pageName.equals("join.jsp") || pageName.equals("notice.jsp") || pageName.equals("noticeview.jsp") || pageName.equals("noticeupdate.jsp")
         || pageName.equals("q&a.jsp")
         || pageName.equals("review.jsp") || pageName.equals("reviewboard.jsp") || pageName.equals("reviewupdate.jsp") || pageName.equals("reviewview.jsp")) {
      path = "../../";
   } else {
      path = "../";
   }
    ...
    <a id="MOVE_TOP_BTN" href="#">TOP</a><!-- 탑버튼 -->
      ...
      <nav class="primary-nav" role="navigation">
         <ul>
            ...
            <li><a href="<%=path%>community/notice/notice.jsp">커뮤니티</a></li>
         </ul>
      </nav>
   </div>
</header>
